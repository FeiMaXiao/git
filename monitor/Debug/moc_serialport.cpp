...
QT_MOC_LITERAL(1, 11, 14), // "signal_recData"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 1) // "b"

    },
    "SerialPort\0signal_recData\0\0b"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_recData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialPort::signal_recData)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void SerialPort::signal_recData(QByteArray _t1)
{
